...
export const statesAndDistricts = {
  ...
  "Chhattisgarh": [
    ...
    "Raigarh", "Raipur", "Rajnandgaon", "Sukma", "Surajpur", "Surguja", "Manendragarh-Chirmiri-Bharatpur", 
    "Mohla-Manpur-Ambagarh Chowki", "Sarangarh-Bilaigarh", "Sakti", "Khairagarh-Chhuikhadan-Gandai"
  ],
  "Goa": [
    "North Goa", "South Goa"
  ],
  ...
  "Madhya Pradesh": [
    ...
    "Shivpuri", "Sidhi", "Singrauli", "Tikamgarh", "Ujjain", "Umaria", "Vidisha", "Mauganj", "Pandhurna", 
    "Maihar"
  ],
  "Maharashtra": [
  ...
  "Punjab": [
    ...
    "Patiala", "Rupnagar", "Sahibzada Ajit Singh Nagar (Mohali)", "Sangrur", "Shaheed Bhagat Singh Nagar", 
    "Sri Muktsar Sahib", "Tarn Taran", "Malerkotla"
  ],
  "Rajasthan": [
    ...
    "Rajsamand", "Sawai Madhopur", "Sikar", "Sirohi", "Sri Ganganagar", "Tonk", "Udaipur", "Beawar", 
    "Balotra", "Deeg", "Didwana-Kuchaman", "Dudu", "Gangapur City", "Jaipur North", "Jaipur South", 
    "Jodhpur East", "Jodhpur West", "Kekri", "Kotputli-Behror", "Khairthal-Tijara", "Neem Ka Thana", 
    "Phalodi", "Salumbar", "Shahpura", "Sanchore"
  ],
  "Sikkim": [
  ...
  "West Bengal": [
    ...
    "North 24 Parganas", "Paschim Bardhaman (West Bardhaman)", "Paschim Medinipur (West Medinipur)", 
    "Purba Bardhaman (East Bardhaman)", "Purba Medinipur (East Medinipur)", "Purulia", "South 24 Parganas", 
    "Uttar Dinajpur (North Dinajpur)"
  ],
  // Union Territories - no districts
...
export const allStatesAndUTs = Object.keys(statesAndDistricts);

// Check if a state is a Union Territory
export const isUnionTerritory = (state) => {
  ...
  return unionTerritories.includes(state);
};
